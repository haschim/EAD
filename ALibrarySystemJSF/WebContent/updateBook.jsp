...
<body>
	<f:view>
		<h:form styleClass="form flex--column center--horizontal">			
			...
			<h:commandButton value="Update Book" action="#{bookController.updateBook}" onclick="alert('This action is irreversible, to confirm book details modifications, please press ok!!!')" styleClass="form__button yellow--btn"/>
		</h:form>
